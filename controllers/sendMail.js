...
const sendEmail = (to, url) => {
	...
	const mailOptions = {
		...
		<div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
            ...
            <a href=${url} style="background: crimson; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">Confirm Mail</a>
	...
	smtpTransport.sendMail(mailOptions, (error, information) => {
		if (error) {
			return error;
		}
		return information;
